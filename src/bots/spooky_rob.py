...
class spooky_rob(commands.Bot):
    ...
    async def play_random_sound(self):
        ...
        try:
            # voice_client.play(disc.FFmpegPCMAudio(source=f'C:/Code/alf-bot/src/bots/sounds/sr_{random.randint(0,41)}.mp3'), after=lambda e: print('done', e))
            voice_client.play(disc.FFmpegPCMAudio(source=f'/home/pi/code/alf-bot/src/bots/sounds/sr_{random.randint(0,41)}.mp3'), after=lambda e: print('done', e))
